<script setup>
defineOptions({ name: "MenuStyling" });
...
const options2 = getMenuBarOptions();
</script>

<template>
	<div class="demo-box">
		<h3>Style for menu bar</h3>
		<MenuBar css="custom-bar" menu-css="custom-menu" :options="options2" />
	</div>
	<div class="demo-box">
